...
foreach ($needle in @(
    ...
    'MZF_MZ800_SHORT_GAP_SHORT_PULSES 6344U',
    'MZF_IC_TURBO_GAP_SHORT_PULSES 5500U',
    'MZF_TC_1_2_TURBO_GAP_SHORT_PULSES 11239U',
    'MZF_TC_1_3_TURBO_GAP_SHORT_PULSES 15130U')) {
